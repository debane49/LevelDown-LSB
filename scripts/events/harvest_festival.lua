         ...
         onTrigger = function(player, npc)
                local candyItems =
                {
                    [6187] = { -- Slimeulation Candy
                        {item = 18102, cost = 10, name = "Pitchfork"},
                        {item = 18103, cost = 20, name = "Pitchfork +1"},
                        {item = 17565, cost = 10, name = "Trick Staff"},
                        {item = 17566, cost = 20, name = "Treat Staff"},
                        {item = 203, cost = 5, name = "Bomb Lantern"},
                        {item = 204, cost = 5, name = "Pumpkin Lantern"},
                        {item = 205, cost = 5, name = "Mandra Lantern"},
                        {item = 456, cost = 5, name = "Pepo Lantern"},
                        {item = 457, cost = 5, name = "Cushaw Lantern"},
                        {item = 458, cost = 5, name = "Calabazilla Lant."},
                        {item = 3622, cost = 5, name = "Jack-o'-Pricket"},
                        {item = 3623, cost = 5, name = "Djinn Pricket"},
                        {item = 3624, cost = 5, name = "Korrigan Pricket"},
                        {item = 3646, cost = 5, name = "Mandra. Pricket"},
                        {item = 3647, cost = 5, name = "Spook-a-Swirl"},
                        {item = 3648, cost = 5, name = "C. Grumpkin"},
                        {item = 3649, cost = 5, name = "Harvest Horror"},
                        {item = 3651, cost = 5, name = "Harvest Pastry"},
                        {item = 5644, cost = 1, name = "Jack-o'-Pie"},
                        {item = 4488, cost = 1, name = "Jack-o'-Lantern"},
                             },
                    [6188] = { -- She-Slime Candy
                        {item = 25711, cost = 10, name = "Botulus Suit"},
                        {item = 25712, cost = 20, name = "Botulus Suit +1"},
                        {item = 10446, cost = 10, name = "Ahriman Cap"},
                        {item = 10447, cost = 10, name = "Pyracmon Cap"},
                        {item = 26707, cost = 10, name = "Flan Masque"},
                        {item = 26708, cost = 20, name = "Flan Masque +1"},
                        {item = 25586, cost = 10, name = "Kakai Cap"},
                        {item = 25587, cost = 20, name = "Kakai Cap +1"},
                        {item = 13916, cost = 10, name = "Pumpkin Head"},
                        {item = 15176, cost = 20, name = "Pumpkin Head II"},
                        {item = 13917, cost = 10, name = "Horror Head"},
                        {item = 15177, cost = 20, name = "Horror Head II"},
                        {item = 16075, cost = 10, name = "Witch Hat"},
                        {item = 16076, cost = 20, name = "Coven Hat"},
                        {item = 11300, cost = 10, name = "Eerie Cloak"},
                        {item = 11301, cost = 20, name = "Eerie Cloak +1"},
                        {item = 25910, cost = 10, name = "Cait Sith Subligar"},
                             },
                    [6189] = { -- Metal Slime Candy
                        {item = 10065, cost = 20, name = "Spectral Chair"},
