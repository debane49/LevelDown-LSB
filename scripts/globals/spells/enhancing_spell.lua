...
-- Structure:            [spellId] = { Tier, Main_Effect, Spell_Level, Base_Power, Base_Duration, Composure, Always_Overwrite, Tick_Seconds },
    ...
    -- Flurry
    [xi.magic.spell.FLURRY       ] = { 1, xi.effect.FLURRY,        48,   15,  180, true,  false, 0 }, -- Thats the actual effect. Not a typo.
    [xi.magic.spell.FLURRY_II    ] = { 2, xi.effect.FLURRY,        96,   30,  180, true,  false, 0 }, -- Thats the actual effect. Not a typo.
