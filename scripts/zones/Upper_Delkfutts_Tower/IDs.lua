...
zones[xi.zone.UPPER_DELKFUTTS_TOWER] =
{
    text =
    {
        ...
        PLAYER_OBTAINS_ITEM           = 7390,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7391,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7392,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7393,  -- You already possess that temporary item.
        NO_COMBINATION                = 7398,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 9476,  -- New training regime registered!
        LEARNS_SPELL                  = 10524, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 10526, -- You are assaulted by an uncanny sensation.
