...
zones[xi.zone.BOSTAUNIEUX_OUBLIETTE] =
{
    text =
    {
        ...
        CHUMIA_DIALOG                 = 7324,  -- Welcome to Bostaunieux Oubliette...
        SEEMS_LOCKED                  = 7326,  -- It seems to be locked.
        SPIRAL_HELL_LEARNED           = 7433,  -- You have learned the weapon skill Spiral Hell!
        SENSE_OMINOUS_PRESENCE        = 7434,  -- You sense an ominous presence...
        ITEMS_ITEMS_LA_LA             = 7437,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7443,  -- The Goblin slipped away when you were not looking...
        REGIME_REGISTERED             = 9548,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 10600, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 10601, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 10602, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 10603, -- You already possess that temporary item.
        NO_COMBINATION                = 10608, -- You were unable to enter a combination.
        LEARNS_SPELL                  = 10632, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 10634, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 10641, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        UNITY_WANTED_BATTLE_INTERACT  = 10705, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
