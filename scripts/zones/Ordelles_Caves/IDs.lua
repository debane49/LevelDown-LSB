...
zones[xi.zone.ORDELLES_CAVES] =
{
    text =
    {
        ...
        RUILLONT_INITIAL_DIALOG       = 7361,  -- Confound it! If I only had my sword, I'd cut through these fiends single-handedly...
        PLACE_HANDS_IN_POOL           = 7372,  -- You place your hands into the pool.
        DEW_SLIPS_THROUGH_FINGERS     = 7375,  -- The dew from the stalactite slips through your fingers.
        ALREADY_OBTAINED_DEW          = 7376,  -- You have already obtained the dew.
        CHEST_UNLOCKED                = 7408,  -- You unlock the chest!
        GERWITZS_AXE_DIALOG           = 7430,  -- Mine axe shall rend thy throat!
        GERWITZS_SWORD_DIALOG         = 7431,  -- Mine sword shall pierce thy tongue!
        GERWITZS_SOUL_DIALOG          = 7432,  -- Long have I waited. I will tell all...
        PLAYER_OBTAINS_ITEM           = 8393,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8394,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8395,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8396,  -- You already possess that temporary item.
        NO_COMBINATION                = 8401,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 10479, -- New training regime registered!
