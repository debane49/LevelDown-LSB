...
zones[xi.zone.QUICKSAND_CAVES] =
{
    text =
    {
        ...
        DOOR_FIRMLY_SHUT              = 7340,  -- The door is firmly shut.
        ANCIENT_LETTERS_UNREAD        = 7349,  -- Ancient letters are carved here, but you are unable to read them.
        POOL_OF_WATER                 = 7372,  -- It is a pool of water.
        SENSE_SOMETHING_EVIL          = 7373,  -- You sense something evil.
        YOU_FIND_NOTHING_OUT          = 7374,  -- You find nothing out of the ordinary.
        YOU_FIND_NOTHING              = 7375,  -- You find nothing.
        SOMETHING_ATTACKING_YOU       = 7379,  -- Something is attacking from behind you!
        SOMETHING_IS_BURIED           = 7380,  -- Something is buried in this fallen pillar.
        SENSE_OMINOUS_PRESENCE        = 7384,  -- You sense an ominous presence...
        PLAYER_OBTAINS_ITEM           = 8292,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8293,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8294,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8295,  -- You already possess that temporary item.
        NO_COMBINATION                = 8300,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 10378, -- New training regime registered!
