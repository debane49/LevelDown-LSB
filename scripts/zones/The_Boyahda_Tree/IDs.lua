...
zones[xi.zone.THE_BOYAHDA_TREE] =
{
    text =
    {
        ...
        CHEST_UNLOCKED                = 7173,  -- You unlock the chest!
        CAN_SEE_SKY                   = 7186,  -- You can see the sky from here.
        SOMETHING_NOT_RIGHT           = 7187,  -- Something is not right!
        CANNOT_SEE_MOON               = 7188,  -- You cannot see the moon right now.
        CONQUEST_BASE                 = 7189,  -- Tallying conquest results...
        WARDEN_SPEECH                 = 7348,  -- Pi...!
        WARDEN_TRANSLATION            = 7349,  -- The warden appears to want something from you...
        SENSE_OMINOUS_PRESENCE        = 7409,  -- You sense an ominous presence...
        REGIME_REGISTERED             = 10352, -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 11404, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 11405, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 11406, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 11407, -- You already possess that temporary item.
        NO_COMBINATION                = 11412, -- You were unable to enter a combination.
