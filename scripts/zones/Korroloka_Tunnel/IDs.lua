...
zones[xi.zone.KORROLOKA_TUNNEL] =
{
    text =
    {
        ...
        FILL_FLASK                    = 7347,  -- You carefully draw the water stored in the clam into <keyitem>.
        STILL_LIGHT                   = 7348,  -- The flask still feels light...
        FLASK_FULL                    = 7349,  -- <item> is now full!
        CLAM_EMPTY                    = 7350,  -- The clam is empty.
