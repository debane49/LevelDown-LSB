...
zones[xi.zone.ZERUHN_MINES] =
{
    text =
    {
        ...
        MAKARIM_DIALOG_I              = 7331,  -- Be careful on your way out. Remember, you should give my report to Naji, one of the Mythril Musketeers on post at the President's Office.
        ZELMAN_CANT_RUN_AROUND        = 7356,  -- I can't run around doing everything she tells me to--I have my dignity to uphold!
