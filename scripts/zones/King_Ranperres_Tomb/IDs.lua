...
zones[xi.zone.KING_RANPERRES_TOMB] =
{
    text =
    {
        ...
        HERE_LIES_KING_RANPERRE       = 7261,  -- Here lies King Ranperre. May he rest in peace.
        NOTHING_HAPPENS               = 7263,  -- Nothing happens
        CHANGE_WATER                  = 7264,  -- You change the water.
        WATER_ALREADY_CHANGED         = 7265,  -- The water has already been changed.
        ALREADY_WATER_HERE            = 7266,  -- There is already water here.
        WATERSKIN_LYING_HERE          = 7267,  -- A waterskin is lying here.
