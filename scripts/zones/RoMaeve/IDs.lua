...
zones[xi.zone.ROMAEVE] =
{
    text =
    {
        ...
        PILE_OF_RUBBLE                = 7406,  -- It is nothing but a pile of rubble.
        A_CHILL_RUNS_DOWN_SPINE       = 7407,  -- A chill runs down your spine.
        SENSE_OMINOUS_PRESENCE        = 7410,  -- You sense an ominous presence...
        ITEMS_ITEMS_LA_LA             = 7413,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7419,  -- The Goblin slipped away when you were not looking...
        ...
        UNITY_WANTED_BATTLE_INTERACT  = 7512,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9628,  -- New training regime registered!
        COMMON_SENSE_SURVIVAL         = 11638, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
