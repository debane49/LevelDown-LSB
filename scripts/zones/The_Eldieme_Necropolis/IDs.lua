...
zones[xi.zone.THE_ELDIEME_NECROPOLIS] =
{
    text =
    {
        ...
        BRAZIER_OUT                      = 7356,  -- The brazier's flame is out. You can probably light it using <item>.
        BRAZIER_COOLDOWN                 = 7357,  -- The brazier's flame has completely burnt out. You can't relight it now...
        NOTHING_HAPPENED                 = 7358,  -- Nothing happened...
        BRAZIER_ACTIVE                   = 7359,  -- The brazier's flame continues to burn...
        SKULL_SIX_REMAIN                 = 7361,  -- An eerie voice echoes in your skull: (Six remain...)
        SKULL_FIVE_REMAIN                = 7362,  -- An eerie voice echoes in your skull: (Five remain...)
        SKULL_FOUR_REMAIN                = 7363,  -- An eerie voice echoes in your skull: (Four remain...)
        SKULL_THREE_REMAIN               = 7364,  -- An eerie voice echoes in your skull: (Three remain...)
        SKULL_TWO_REMAIN                 = 7365,  -- An eerie voice echoes in your skull: (Two remain...)
        SKULL_ONE_REMAIN                 = 7366,  -- An eerie voice echoes in your skull: (One remains...)
        SKULL_SPAWN                      = 7367,  -- An eerie voice echoes in your skull: (Know ye our power...)
        RETURN_RIBBON_TO_HER             = 7371,  -- You can hear a voice from somewhere. (...return...ribbon to...her...)
        THE_BRAZIER_IS_LIT               = 7385,  -- The brazier is lit.
        REFUSE_TO_LIGHT                  = 7386,  -- Unexpectedly, the <item> refuses to light.
        LANTERN_GOES_OUT                 = 7387,  -- For some strange reason, the light of the <item> goes out...
        THE_LIGHT_DIMLY                  = 7388,  -- The <item> lights dimly. It doesn't look like this will be effective yet.
        THE_LIGHT_HAS_INTENSIFIED        = 7389,  -- The light of the <item> has intensified.
        THE_LIGHT_IS_FULLY_LIT           = 7390,  -- The <item> is fully lit!
        SOLID_STONE                      = 7398,  -- This door is made of solid stone.
        CHEST_UNLOCKED                   = 7418,  -- You unlock the chest!
        SPIRIT_INCENSE_EMITS_PUTRID_ODOR = 7428,  -- The <item> emits a putrid odor and burns up. Your attempt this time has failed...
        SARCOPHAGUS_CANNOT_BE_OPENED     = 7445,  -- It is a stone sarcophagus with the lid sealed tight. It cannot be opened.
        SEEMS_TO_BE_THE_END              = 7573,  -- That seems to be the end of it.
        GIRL_BACK_TO_JEUNO               = 7585,  -- I'll take the little girl back to Jeuno. Take care.
        NOT_TIME_TO_SEARCH               = 7597,  -- Now doesn't seem to be the time to search here.
        PUT_TOGUETHER_TO_COMPLETE        = 7599,  -- You put the % you have discovered together to form a complete piece.
        ...
        LEARNS_SPELL                     = 11608, -- <name> learns <spell>!
        UNCANNY_SENSATION                = 11610, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL            = 11644, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
