...
zones[xi.zone.LOWER_DELKFUTTS_TOWER] =
{
    text =
    {
        ...
        SOMETHING_HUGE_BEARING_DOWN      = 7502,  -- Something huge is bearing down upon you!
        PLAYER_OBTAINS_ITEM              = 8637,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM            = 8638,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM         = 8639,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP             = 8640,  -- You already possess that temporary item.
        NO_COMBINATION                   = 8645,  -- You were unable to enter a combination.
        REGIME_REGISTERED                = 10723, -- New training regime registered!
        LEARNS_SPELL                     = 11771, -- <name> learns <spell>!
        UNCANNY_SENSATION                = 11773, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL            = 11780, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
