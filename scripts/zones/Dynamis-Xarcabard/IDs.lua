...
zones[xi.zone.DYNAMIS_XARCABARD] =
{
    text =
    {
        ...
        DYNAMIS_TIME_BEGIN            = 7230, -- The sands of the <item> have begun to fall. You have <number> minutes (Earth time) remaining in Dynamis.
        DYNAMIS_TIME_EXTEND           = 7231, -- our stay in Dynamis has been extended by <number> minute[/s].
        DYNAMIS_TIME_UPDATE_1         = 7232, -- ou will be expelled from Dynamis in <number> [second/minute] (Earth time).
        DYNAMIS_TIME_UPDATE_2         = 7233, -- ou will be expelled from Dynamis in <number> [seconds/minutes] (Earth time).
        DYNAMIS_TIME_EXPIRED          = 7235, -- The sands of the hourglass have emptied...
        OMINOUS_PRESENCE              = 7247, -- You feel an ominous presence, as if something might happen if you possessed <item>.
        ANIMATED_KNUCKLES_DIALOG      = 7314, -- I am known as the Fists of Mystics. Come, show me your fighting spirit.
        ANIMATED_DAGGER_DIALOG        = 7346, -- I am called the Ornate Blade. Now, show me your strength.
        ANIMATED_LONGSWORD_DIALOG     = 7378, -- People have named me the Holy Blade. I will try thy resolution.
        ANIMATED_CLAYMORE_DIALOG      = 7410, -- I am the Intricate Blade. Show me the depths of your fury!
        ANIMATED_TABAR_DIALOG         = 7442, -- Me, axe. Runaeic, Axe. You, die?
        ANIMATED_GREATAXE_DIALOG      = 7474, -- I have been given the title of Seraphic Axe. Will you attempt to survive my love?
        ANIMATED_SPEAR_DIALOG         = 7506, -- I am the Stellar Spear. It is time to test your courage.
        ANIMATED_SCYTHE_DIALOG        = 7538, -- I am known as the Tenebrous Scythe. Overwhelm me with your greed for power.
        ANIMATED_KUNAI_DIALOG         = 7570, -- I am called the Demoniac Blade. Allow me to witness your technique.
        ANIMATED_TACHI_DIALOG         = 7602, -- I am the Divine Blade. I demand a test of your will.
        ANIMATED_HAMMER_DIALOG        = 7634, -- People have named me the Heavenly Hammer. I will test your might to its very limits.
        ANIMATED_STAFF_DIALOG         = 7666, -- I am called the Celestial Staff. I will glimpse into your mind's eye...
        ANIMATED_LONGBOW_DIALOG       = 7698, -- I am known as the Snarled Bow. I will measure the limits of your determination.
        ANIMATED_GUN_DIALOG           = 7730, -- I am known as the Ethereal Rifle. Do you realize my incredible value?
        ANIMATED_HORN_DIALOG          = 7762, -- I am called the Mysterial Horn. Show me your true intentions.
        ANIMATED_SHIELD_DIALOG        = 7794, -- I am Aegis, the impervious shield of everlasting.
        PRISON_OF_SOULS_HAS_SET_FREE  = 7826, -- e prison of souls has set free its captive spirits!
    },
    mob =
    {
        TIME_EXTENSION =
