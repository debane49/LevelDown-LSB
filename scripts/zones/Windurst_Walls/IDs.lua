...
zones[xi.zone.WINDURST_WALLS] =
{
    text =
    {
        ...
        ITEM_DELIVERY_DIALOG           = 6995,  -- We can deliver goods to your residence or to the residences of your friends.
        FISHING_MESSAGE_OFFSET         = 7091,  -- You can't fish here.
        RECEIVE_BAYLD                  = 7189,  -- You receive <number> bayld!
        DOORS_SEALED_SHUT              = 7766,  -- The doors are firmly sealed shut.
        MOGHOUSE_EXIT                  = 8223,  -- You have learned your way through the back alleys of Windurst! Now you can exit to any area from your residence.
        RECEIVED_CONQUEST_POINTS       = 8451,  -- You received <number> conquest points!
        SCAVNIX_SHOP_DIALOG            = 8707,  -- <Pshoooooowaaaaa> I'm goood Goblin from underwooorld.  I find lotshhh of gooodieshhh.  You want try shhhome chipshhh? Cheap for yooou.
        RETRIBUTION_LEARNED            = 9095,  -- You have learned the weapon skill Retribution!
        YOU_CANNOT_ENTER_DYNAMIS       = 9118,  -- You cannot enter Dynamis - [Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia] for <number> [day/days] (Vana'diel time).
        PLAYERS_HAVE_NOT_REACHED_LEVEL = 9120,  -- Players who have not reached level <number> are prohibited from entering Dynamis.
        DYNA_NPC_DEFAULT_MESSAGE       = 9132,  -- The strands of grass here have been tied together.
        IMPERIAL_STANDING_INCREASED    = 9653,  -- Your Imperial Standing has increased!
        EARNED_ALLIED_NOTES            = 9654,  -- You have earned <number> Allied Note[/s]!
        OBTAINED_GUILD_POINTS          = 9655,  -- Obtained: <number> guild points.
        TEAR_IN_FABRIC_OF_SPACE        = 10867, -- There appears to be a tear in the fabric of space...
    },
    mob =
    {
    },
