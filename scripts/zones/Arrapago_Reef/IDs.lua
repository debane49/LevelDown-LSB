...
zones[xi.zone.ARRAPAGO_REEF] =
{
    text =
    {
        ...
        MEDUSA_ENGAGE                 = 8579, -- Foolish two-legs... Have you forgotten the terrible power of the gorgons you created? It is time you were reminded...
        MEDUSA_DEATH                  = 8580, -- No... I cannot leave my sisters...
        GLITTERING_FRAGMENTS          = 8903, -- Minute glittering fragments are scattered all over...
        STIFLING_STENCH               = 8916, -- A stifling stench pervades the air...
        SLIMY_TOUCH                   = 8921, -- The ground here is slimy to the touch...
        FLUTTERY_OBJECTS              = 8927, -- Light, fluttery objects litter the ground...
        DRAWS_NEAR                    = 8932, -- Something draws near!
        COMMON_SENSE_SURVIVAL         = 9803, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
