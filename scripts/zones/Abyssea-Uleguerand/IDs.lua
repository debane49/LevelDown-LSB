...
zones[xi.zone.ABYSSEA_ULEGUERAND] =
{
    text =
    {
        ...
        OBTAINS_DOMINION_NOTES        = 7781,  -- <name> obtains <number> Dominion note[/s] (Total: <number>).
        DOMINION_SIGNED_ON            = 10301, -- You have signed on for Dominion Ops!
        CANCELED_OBJECTIVE            = 10302, -- You have canceled your objective.
    },
    mob =
    {
