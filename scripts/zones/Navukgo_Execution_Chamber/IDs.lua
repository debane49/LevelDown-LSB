...
zones[xi.zone.NAVUKGO_EXECUTION_CHAMBER] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7601, -- Entering the battlefield for [Tough Nut to Crack/Happy Caster/Omens/Achieving True Power/Shield of Diplomacy/An Imperial Heist]!
