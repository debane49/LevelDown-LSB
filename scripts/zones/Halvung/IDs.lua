...
zones[xi.zone.HALVUNG] =
{
    text =
    {
        ...
        WIDE_TRENCH                   = 7923, -- There is a wide trench around the gate here. There are three keyholes of differing sizes inside the trench.
        MINING_IS_POSSIBLE_HERE       = 7946, -- Mining is possible here if you have <item>.
        BLUE_FLAMES                   = 7986, -- You can see blue flames flickering from a hole in the ground here...
        SICKLY_SWEET                  = 8038, -- A sickly sweet fragrance pervades the air...
        THIN_LAYER_OF_CINDER          = 8045, -- The ground is carpeted in a thin layer of cinder.
        DRAWS_NEAR                    = 8060, -- Something draws near!
        DULL_PIECE                    = 8061, -- A dull piece of metal lies on the ground. It appears to be a bracelet of sorts, but the layers of grime covering its surface render it wholly unwearable.
        LIFT_LEVER                    = 8064, -- You lift the lever with all your might!
        UNITY_WANTED_BATTLE_INTERACT  = 8103, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
