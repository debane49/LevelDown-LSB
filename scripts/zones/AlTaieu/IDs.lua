...
zones[xi.zone.ALTAIEU] =
{
    text =
    {
        ...
        QUASILUMIN_01                 = 7381, -- This is Al'Taieu. The celestial capital overflowing with the blessings of Altana.
        IMPERVIOUS_FIELD_BLOCKS       = 7462, -- An impervious field of energy blocks your path...
        NOTHING_OF_INTEREST           = 7491, -- There is nothing of interest here.
        OMINOUS_SHADOW                = 7492, -- An ominous shadow falls over you...
        AMULET_SHATTERED              = 7513, -- The <item> held by <name> has shattered...
        LIGHT_STOLEN                  = 7514, -- The <item> was stolen by Nag'molada...
        OBTAIN_BUT_STOLEN             = 7515, -- You obtain the <item>, only to have it stolen by Nag'molada...
        RETURN_AMULET_TO_PRISHE       = 7539, -- You return the <item> to Prishe.
        HOMEPOINT_SET                 = 7580, -- Home point set!
    },
    mob =
    {
