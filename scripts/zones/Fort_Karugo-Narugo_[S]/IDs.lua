...
zones[xi.zone.FORT_KARUGO_NARUGO_S] =
{
    text =
    {
        ...
        SPONDULIX_SHOP_DIALOG         = 7220, -- Spondulix comes all the way from Boodlix's Emporium to help Tarutaru and Mithra. I can help you, too! You have gil, no?
        ...
        ITEM_DELIVERY_DIALOG          = 8126, -- Deliveries! We're open for business!
        COMMON_SENSE_SURVIVAL         = 9205, -- It appears that you have arrived at a new survival guide provided by the Servicemen's Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
