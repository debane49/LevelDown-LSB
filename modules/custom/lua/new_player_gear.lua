...
m:addOverride('xi.player.charCreate', function(player)
        ...
        if xi.settings.main.NEW_CHARACTER_CUTSCENE == 0 then 
            ...
            -- fame
            player:addFame(xi.quest.fame_area.BASTOK, 30000)
            player:addFame(xi.quest.fame_area.SANDORIA, 30000)
            player:addFame(xi.quest.fame_area.JEUNO, 30000)
            player:addFame(xi.quest.fame_area.NORG, 30000)
            player:addFame(xi.quest.fame_area.WINDURST, 30000)
        end
