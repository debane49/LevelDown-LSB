    ...
    local Pyo = zone:insertDynamicEntity({
     ...
     onTrade = function(player, npc, trade)
        ...
        onTrigger = function(player, npc)
           ...
           player:printToPlayer('1 Zeni point will be awareded for every Imperial Bronze piece you trade me.', 0, 'Pyo')
           player:printToPlayer('5 Zeni points will be awareded for every Imperial Silver piece you trade me.', 0, 'Pyo')
           player:printToPlayer('10 Zeni points will be awareded for every Imperial Mythril piece you trade me.', 0, 'Pyo')
           player:printToPlayer('15 Zeni points will be awareded for every Imperial Gold piece you trade me.', 0, 'Pyo')
           player:printToPlayer(string.format('Your current Zeni balance is %s.',player:getCurrency('zeni_point')), 0, 'Pyo')
        end,
    })
    utils.unused(Pyo)
