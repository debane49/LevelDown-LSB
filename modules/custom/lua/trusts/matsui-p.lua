...
local m = Module:new('matsui-p')

m:addOverride("xi.actions.spells.trust.matsui-p.onMagicCastingCheck", function(caster, target, spell)
    return xi.trust.canCast(caster, spell)
end)

m:addOverride("xi.actions.spells.trust.matsui-p.onSpellCast", function(caster, target, spell)
end)

m:addOverride("xi.actions.spells.trust.matsui-p.onMobSpawn", function(mob)
...
m:addOverride("xi.actions.spells.trust.matsui-p.onMobDespawn", function(mob)
    xi.trust.message(mob, xi.trust.messageOffset.DESPAWN)
end)

m:addOverride("xi.actions.spells.trust.matsui-p.onMobDeath", function(mob)
