...
--[[
Need access- 6k CP/kill 99+
--Escha-Zitah (F-6) - Dragons and puks - 288 ESCHA_ZITAH
--Escha-Zitah (L-10) Yztarg and Opo-opo  - 288 ESCHA_ZITAH

Has access - 10k+ CP/kill SU2+
----Ra'Kaznar Inner Court (L-4) - 276  RAKAZNAR_INNER_COURT 

Has access - 15k+ CP/kill SU3+
-- Dho gates (J-11) Apex mobs - 272 DHO_GATES
--Moh gates (K-6) Apex mobs - 269 MOH_GATES
Sih gates (K-7) Apex mobs - 268 SIH_GATES
Sih gates (L-8) Apex mobs - 268 SIH_GATES
Sih gates (J-9) Apex mobs - 268 SIH_GATES
--Reisenjima - any mob - 291 REISENJIMA

Has access - 60k+ CP/kill SU3+ PT
----Bhaflau Thickets (F-5) Colibri - 52 BHAFLAU_THICKETS
----King Ranperre's Tomb (H-9) Beetles  - 190 KING_RANPERRES_TOMB
]]--
