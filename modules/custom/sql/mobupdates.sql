...
--						Mob Group settings						--
--							Zone 190						--
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Spartoi_Sorcerer";
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Spartoi_Warrior";
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Cutlass_Scorpion";
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Thousand_Eyes";
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Hati";
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Armet_Beetle";
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Dire_Bat";
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Tomb_Worm";
--							Zone 4							--
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Bight_Rarab";
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Camelopard";
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Hypnos_Eft";
UPDATE mob_groups SET HP = 13000 WHERE name = "Locus_Ghost_Crab";
--						Mob Family settings						--
