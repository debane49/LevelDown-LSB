...
UPDATE mob_groups SET dropid = 3919 WHERE name = 'Ixaern_mnk' AND groupid = 24;
...
INSERT INTO mob_droplist VALUES(3919,1,1,1000,4065,250);-- Rem tale 2 / NMs Ix'aern (MNK)
INSERT INTO mob_droplist VALUES(3919,1,1,1000,4066,250);-- Rem tale 3 / NMs Ix'aern (MNK)
INSERT INTO mob_droplist VALUES(3919,1,2,1000,837,250);-- Malboro Fiber / NMs Ix'aern (MNK)
INSERT INTO mob_droplist VALUES(3919,1,2,1000,844,250);-- Phoenix Feather / NMs Ix'aern (MNK)
INSERT INTO mob_droplist VALUES(3919,1,3,1000,20819,500);-- Antican Axe / NMs Ix'aern (MNK)
INSERT INTO mob_droplist VALUES(3919,1,3,1000,20730,500);-- Predatrice / NMs Ix'aern (MNK)