...
INSERT INTO mob_droplist VALUES(3911,0,0,250,27048,200);-- Telchine Gloves / VWNM Stachysaurus
INSERT INTO mob_droplist VALUES(3911,0,0,250,27049,200);-- Helios Gloves / VWNM Stachysaurus
INSERT INTO mob_droplist VALUES(3912,0,0,250,27233,200);-- Acro Breeches / VWNM Gwynn_Ap_Nudd
INSERT INTO mob_droplist VALUES(3912,0,0,250,27232,200);-- Yorium Cuisses / VWNM Gwynn_Ap_Nudd
INSERT INTO mob_droplist VALUES(3912,0,0,250,27234,200);-- Taeon Tights / VWNM Gwynn_Ap_Nudd
INSERT INTO mob_droplist VALUES(3912,0,0,250,27235,200);-- Telchine Braconi / VWNM Gwynn_Ap_Nudd
INSERT INTO mob_droplist VALUES(3912,0,0,250,27236,200);-- Helios Spats / VWNM Gwynn_Ap_Nudd
INSERT INTO mob_droplist VALUES(3913,0,0,250,27403,200);-- Acro Leggings / VWNM Smierc
INSERT INTO mob_droplist VALUES(3913,0,0,250,27402,200);-- Yorium Sabatons / VWNM Smierc
INSERT INTO mob_droplist VALUES(3913,0,0,250,27404,200);-- Taeon Boots / VWNM Smierc
INSERT INTO mob_droplist VALUES(3913,0,0,250,27405,200);-- Telchine Pigaches / VWNM Smierc
...
UPDATE mob_groups SET dropid = 3891 WHERE name =  'Bismarck'AND groupid =  50;
UPDATE mob_groups SET dropid = 3868 WHERE name =  'Sabotender_Campeador'AND groupid =  39;
UPDATE mob_groups SET dropid = 3884 WHERE name =  'Mellonia'AND groupid =  40;
UPDATE mob_groups SET dropid = 3906 WHERE name =  'Hahava'AND groupid =  44;
UPDATE mob_groups SET dropid = 3881 WHERE name =  'Ogbunabali'AND groupid =  43;
UPDATE mob_groups SET dropid = 3879 WHERE name =  'Lorbulcrud'AND groupid =  43;
UPDATE mob_groups SET dropid = 3910 WHERE name =  'Rw_Nw_Prt_M_Hrw'AND groupid =  29;
UPDATE mob_groups SET dropid = 3870 WHERE name =  'Malleator_Maurok'AND groupid =  42;
UPDATE mob_groups SET dropid = 3899 WHERE name =  'Kaggen'AND groupid =  51;
UPDATE mob_groups SET dropid = 3859 WHERE name =  'Goji'AND groupid =  58;
UPDATE mob_groups SET dropid = 3856 WHERE name =  'Cottus'AND groupid =  151;
UPDATE mob_groups SET dropid = 3913 WHERE name =  'Smierc'AND groupid =  42;
UPDATE mob_groups SET dropid = 3909 WHERE name =  'Bhishani'AND groupid =  34;
UPDATE mob_groups SET dropid = 3896 WHERE name =  'Kholomodumo'AND groupid =  156;
UPDATE mob_groups SET dropid = 3865 WHERE name =  'Holy_Moly'AND groupid =  53;
UPDATE mob_groups SET dropid = 3871 WHERE name =  'Fjalar'AND groupid =  55;
UPDATE mob_groups SET dropid = 3854 WHERE name =  'Ushumgal'AND groupid =  158;
UPDATE mob_groups SET dropid = 3872 WHERE name =  'Abununnu'AND groupid =  75;
UPDATE mob_groups SET dropid = 3902 WHERE name =  'Aello'AND groupid =  20;
UPDATE mob_groups SET dropid = 3862 WHERE name =  'Agathos'AND groupid =  167;
UPDATE mob_groups SET dropid = 3898 WHERE name =  'Akupara'AND groupid =  159;
UPDATE mob_groups SET dropid = 3900 WHERE name =  'Akvan'AND groupid =  30;
UPDATE mob_groups SET dropid = 3895 WHERE name =  'Belphoebe'AND groupid =  79;
UPDATE mob_groups SET dropid = 3918 WHERE name =  'Botulus_Rex'AND groupid =  53;
UPDATE mob_groups SET dropid = 3876 WHERE name =  'Brekekekex'AND groupid =  66;
UPDATE mob_groups SET dropid = 3888 WHERE name =  'Cath_Palug'AND groupid =  57;
...
UPDATE mob_groups SET dropid = 3917 WHERE name =  'Ig-Alima'AND groupid =  71;
UPDATE mob_groups SET dropid = 3866 WHERE name =  'Ildebrann'AND groupid =  31;
UPDATE mob_groups SET dropid = 3874 WHERE name =  'Isarukitsck'AND groupid =  54;
UPDATE mob_groups SET dropid = 3916 WHERE name =  'Kalasutrax'AND groupid =  140;
UPDATE mob_groups SET dropid = 3880 WHERE name =  'Krabimanjaro'AND groupid =  52;
UPDATE mob_groups SET dropid = 3883 WHERE name =  'Laidly_Laurence'AND groupid =  127;
UPDATE mob_groups SET dropid = 3908 WHERE name =  'Lancing_Lamorak'AND groupid =  37;
UPDATE mob_groups SET dropid = 3897 WHERE name =  'Lord_Asag'AND groupid =  70;
UPDATE mob_groups SET dropid = 3894 WHERE name =  'Melancholic_Moira'AND groupid =  156;
UPDATE mob_groups SET dropid = 3890 WHERE name =  'Mimic_King'AND groupid =  20;
UPDATE mob_groups SET dropid = 3889 WHERE name =  'Modron'AND groupid =  37;
UPDATE mob_groups SET dropid = 3892 WHERE name =  'Morta'AND groupid =  35;
UPDATE mob_groups SET dropid = 3893 WHERE name =  'Murk-veined_Baneberry'AND groupid =  72;
UPDATE mob_groups SET dropid = 3867 WHERE name =  'Neith'AND groupid =  48;
UPDATE mob_groups SET dropid = 3885 WHERE name =  'Nympha_Eunomia'AND groupid =  120;
UPDATE mob_groups SET dropid = 3915 WHERE name =  'Ocythoe'AND groupid =  156;
UPDATE mob_groups SET dropid = 3858 WHERE name =  'Pancimanci'AND groupid =  164;
UPDATE mob_groups SET dropid = 3901 WHERE name =  'Pil-VNM'AND groupid =  17;
UPDATE mob_groups SET dropid = 3904 WHERE name =  'Qilin'AND groupid =  33;
UPDATE mob_groups SET dropid = 3882 WHERE name =  'Roly-Poly'AND groupid =  44;
UPDATE mob_groups SET dropid = 3853 WHERE name =  'Sallow_Seymour'AND groupid =  49;
UPDATE mob_groups SET dropid = 3855 WHERE name =  'Sarimanok'AND groupid =  30;
UPDATE mob_groups SET dropid = 3911 WHERE name =  'Stachysaurus'AND groupid =  55;
UPDATE mob_groups SET dropid = 3869 WHERE name =  'Tangaroa'AND groupid =  40;
UPDATE mob_groups SET dropid = 3864 WHERE name =  'Taweret'AND groupid =  155;
UPDATE mob_groups SET dropid = 3873 WHERE name =  'Tsui-Goab'AND groupid =  60;
UPDATE mob_groups SET dropid = 3903 WHERE name =  'Uptala'AND groupid =  17;
UPDATE mob_groups SET dropid = 3878 WHERE name =  'Vanasarvik'AND groupid =  55;
